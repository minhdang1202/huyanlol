...
const ArticleSummary = ({ data, isHeaderAction, isAction, isSummaryReact, className }) => {
...
ArticleSummary.defaultProps = { isAction: true, isHeaderAction: true, isSummaryReact: true };
